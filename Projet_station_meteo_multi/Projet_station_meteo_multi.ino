...
unsigned long t_lastActionPluvio = 0;             // enregistre le Time de la dernière intérogation des capteurs.
#define INTERO_PLUVIO 120                         // Valeur de l'intervale en secondes entre 2 relevés des capteurs.
...
void loop() {
  ...
  // On vérifie si l'intervale d'envoi des informations pluie dont atteintes. (120s)
